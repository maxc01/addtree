...
def testing_cfg_35():
    return {
        "root": "ln",
        "r2_1": 0.9675994230402243,
        "r2_2": 0.9262575637588707,
        "x2": "l1",
        "r5_1": 0.5498642496951367,
        "r5_2": 0.3537214488306732,
        "x5": "ln",
        "r12_1": 0.9730682436076921,
        "r12_2": 0.05481513254257234,
    }


def cfg2funcparams_35(cfg):
    ...
    def extract_using_prefix(keys):
        ...
        for k in keys:
            if k in cfg_prefix:
                return [cfg[k + "_1"], cfg[k + "_1"], cfg[k + "_2"]]
        raise RuntimeError("key not exist")
