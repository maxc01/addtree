...
from addtree_utils import build_tree_resnet20_nas
from addtree_utils import path2funcparam_resnet20_nas
...
def main():
    ...
    try:
        ...
        for i in range(n_init):
            ...
            ss.add(
                path.path2vec(obs_dim), obj_info["value"], obs_sigma, path,
            )
