...
def testing_cfg():
    return {
        "root": "l1",
        "r1_1": 0.7325497717745826,
        "r1_2": 0.34164504389612943,
        "r1_3": 0.5211620038232283,
        "x1": "ln",
        "r4_1": 0.40540439341197976,
        "r4_2": 0.01476505741787909,
        "r4_3": 0.031323481210716375,
        "x4": "ln",
        "r10_1": 0.5298709384652244,
        "r10_2": 0.5616403538459042,
        "r10_3": 0.5043322521730372,
    }
...
def cfg2funcparams(cfg):
    ...
    params = {}
    params["layer1"] = {}
    params["layer1"]["prune_method"] = cfg["root"]
    params["layer1"]["amount"] = extract_using_prefix(["r1", "r2"])

    params["layer2"] = {}
    params["layer2"]["prune_method"] = extract_one_value(["x1", "x2"])
    params["layer2"]["amount"] = extract_using_prefix(["r3", "r4", "r5", "r6"])

    params["layer3"] = {}
    params["layer3"]["prune_method"] = extract_one_value(["x3", "x4", "x5", "x6"])
    params["layer3"]["amount"] = extract_using_prefix(
